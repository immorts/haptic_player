...
public interface DataReader {
  ...
  int read(byte[] buffer, int offset, int length,boolean isAudio) throws IOException;

  int read(byte[] buffer, int offset, int length,byte[] hapticBuffer,boolean isAudio) throws IOException;
}
